...
def api_base_map_today():
    ...
    for row in rows:
        ...
        item = {
            ...
            "player_names_text": str(row.get("player_names_text") or "").strip(),
            "class_history_text": str(row.get("class_history_text") or "").strip(),
            "player_stat_text": str(row.get("player_stat_text") or "").strip(),
            "player_reason_text": str(row.get("player_reason_text") or "").strip(),
            ...
            "base_raw_score": safe_float(row.get("base_raw_score"), 0),
            "base_raw_label": str(row.get("base_raw_label") or "").strip(),
            "base_raw_reason_text": str(row.get("base_raw_reason_text") or "").strip(),
